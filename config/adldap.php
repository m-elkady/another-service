            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'openldap')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=another-service,dc=me'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'cn=admin,dc=another-service,dc=me'),
